...
namespace Survive
{
    static class TileMap
    {
        ...
        static public void Initialize(Texture2D tileTexture)
        {
            ...
            tiles.Add(new Rectangle(128, 0, TileWidth, TileHeight));
            tiles.Add(new Rectangle(192, 0, TileWidth, TileHeight));
            ...
            tiles.Add(new Rectangle(192, 64, TileWidth, TileHeight));
        ...
        static public void GenerateRandomMap()
        {
            ...
            for (int x = 0; x < MapWidth; x++)
                for (int y = 0; y < MapHeight; y++)
                {
                    floorTile = rand.Next(FloorTileStart, FloorTileEnd + 1);
                    wallTile = rand.Next(WallTileStart, WallTileEnd + 1);
