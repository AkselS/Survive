...
namespace Survive
{
    public class Enemy2
    {
        ...
        private int alertRadius = 200;
        public static bool alertedStatus = false;
        ...
        {
            animations.Add("EIdle", new Animation(content.Load<Texture2D>(@"Textures/Enemy/Green/Idle"), 64, "EIdle"));
            animations["EIdle"].LoopAnimation = false;

            animations.Add("EUp", new Animation(content.Load<Texture2D>(@"Textures/Enemy/Green/Up"), 64, "EUp"));
            animations["EUp"].LoopAnimation = true;

            animations.Add("EDown", new Animation(content.Load<Texture2D>(@"Textures/Enemy/Green/Down"), 64, "EDown"));
            animations["EDown"].LoopAnimation = true;

            animations.Add("ELeft", new Animation(content.Load<Texture2D>(@"Textures/Enemy/Green/Left"), 64, "ELeft"));
            animations["ELeft"].LoopAnimation = true;

            animations.Add("ERight", new Animation(content.Load<Texture2D>(@"Textures/Enemy/Green/Right"), 64, "ERight"));
            animations["ERight"].LoopAnimation = true;
